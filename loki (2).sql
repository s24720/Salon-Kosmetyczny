...
--
-- Host: 127.0.0.1
-- Czas generowania: 26 Maj 2022, 21:28
...
-- Procedury
--
CREATE DEFINER=`szymon`@`%` PROCEDURE `dodaj_produktv3` (`n` VARCHAR(50), `c` DECIMAL(12,2))  BEGIN
insert into Produkt(nazwa, cena) values(n,c);
END$$
...
(4, 'pracownik1@gmail.com', 'haslo1', 1),
(5, 'pracownik2@gmail.com', 'haslo2', 2),
(6, 'pracownik3@gmail.com', 'haslo3', 2),
(7, 'admin1@gmail.com', 'haslo1', 3),
(8, 'mail@gmail.com', 'haslo', 1),
(9, 'mail@gmail.com', 'haslo', 1),
(10, 'afwefwef', '123', 1),
(11, 'wf', '1324', 1),
(12, 'Jan@wp.pl', 'haslo', 1),
(13, 'marian@gmail.com', 'haslo', 1),
(14, 'Jan@wp.pl', 'Haslo-Haslo123', 1),
(15, 'konewka@gmail.com', 'Haslo-123', 1);
...
(4, 'michal', 'komora', '123456789', 1, 1),
(5, 'irena', 'szymko', '987654321', 2, 2),
(6, 'wanda', 'mróz', '321654987', 3, 3),
(7, 'ff', 'ff', '123', 1, 11),
(8, 'Jan', 'Kowalski', '123456789', 1, 12),
(9, 'Marian', 'Kazik', '123456789', 1, 13),
(10, 'Jan', 'Paproch', '123456789', 1, 12),
(11, 'Szymon', 'Konewka', '123456789', 1, 15);
...
(22, 1, 'Nie ma co dobre', '2022-05-21 16:52:48', 'karol'),
(23, 1, 'Polecam salon', '2022-05-21 17:06:34', 'Iryna'),
(24, 1, 'fajna strona', '2022-05-21 18:54:10', 'karolina'),
(25, 1, 'elo', '2022-05-25 22:23:53', 'karol');
...
(10, 'Chiromasaż drenująco-modelujący', '270.00', '01:00:00', 4),
...
--
-- Indeksy dla tabeli `umiejetnosc_pracownik`
--
ALTER TABLE `umiejetnosc_pracownik`
  ADD PRIMARY KEY (`id`),
  ADD KEY `umiejetnosc_pracownik_Poziom` (`Poziom_id`),
  ADD KEY `umiejetnosc_pracownik_Pracownik` (`Pracownik_id`),
  ADD KEY `umiejetnosc_pracownik_Umiejetnosc` (`Umiejetnosc_id`);
...
ALTER TABLE `wizyta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `Wizyta_Zabieg` (`Zabieg_id`),
  ADD KEY `Wizyty_Klient` (`Klient_id`),
  ADD KEY `Wizyty_Pracownik` (`Pracownik_id`),
  ADD KEY `Wizyty_Salon` (`Salon_id`);
...
ALTER TABLE `zabieg`
  ADD PRIMARY KEY (`id`),
  ADD KEY `Zabieg_Rodzaj` (`Rodzaj_id`);
...
--
-- AUTO_INCREMENT dla tabeli `salon_produkt`
--
ALTER TABLE `salon_produkt`
...
--
-- AUTO_INCREMENT dla tabeli `umiejetnosc_pracownik`
--
ALTER TABLE `umiejetnosc_pracownik`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Ograniczenia dla tabeli `dane_logowanie`
--
ALTER TABLE `dane_logowanie`
  ADD CONSTRAINT `Dane_logowanie_Rola` FOREIGN KEY (`Rola_id`) REFERENCES `rola` (`id`);

--
-- Ograniczenia dla tabeli `klient`
--
ALTER TABLE `klient`
  ADD CONSTRAINT `Klient_Dane_logowanie` FOREIGN KEY (`Dane_logowanie_id`) REFERENCES `dane_logowanie` (`id`),
  ADD CONSTRAINT `Klient_Salon` FOREIGN KEY (`Salon_id`) REFERENCES `salon` (`id`);

--
-- Ograniczenia dla tabeli `opinie`
--
ALTER TABLE `opinie`
  ADD CONSTRAINT `Opinie_Salon` FOREIGN KEY (`Salon_id`) REFERENCES `salon` (`id`);

--
-- Ograniczenia dla tabeli `powiat`
--
ALTER TABLE `powiat`
  ADD CONSTRAINT `Powiat_Wojewodztwa` FOREIGN KEY (`Wojewodztwa_id`) REFERENCES `wojewodztwa` (`id`);

--
-- Ograniczenia dla tabeli `pracownik`
--
ALTER TABLE `pracownik`
  ADD CONSTRAINT `Pracownik_Dane_logowanie` FOREIGN KEY (`Dane_logowanie_id`) REFERENCES `dane_logowanie` (`id`),
  ADD CONSTRAINT `Pracownik_Powiat` FOREIGN KEY (`Powiat_id`) REFERENCES `powiat` (`id`),
  ADD CONSTRAINT `Pracownik_Salon` FOREIGN KEY (`Salon_id`) REFERENCES `salon` (`id`),
  ADD CONSTRAINT `Pracownik_Wojewodztwa` FOREIGN KEY (`Wojewodztwa_id`) REFERENCES `wojewodztwa` (`id`);

--
-- Ograniczenia dla tabeli `salon`
--
ALTER TABLE `salon`
  ADD CONSTRAINT `Salon_Powiat` FOREIGN KEY (`Powiat_id`) REFERENCES `powiat` (`id`),
  ADD CONSTRAINT `Salon_Wojewodztwa` FOREIGN KEY (`Wojewodztwa_id`) REFERENCES `wojewodztwa` (`id`);

--
-- Ograniczenia dla tabeli `salon_produkt`
--
ALTER TABLE `salon_produkt`
  ADD CONSTRAINT `Salon_Produkt_Produkt` FOREIGN KEY (`Produkt_id`) REFERENCES `produkt` (`id`),
  ADD CONSTRAINT `Salon_Produkt_Salon` FOREIGN KEY (`Salon_id`) REFERENCES `salon` (`id`);

--
-- Ograniczenia dla tabeli `umiejetnosc_pracownik`
--
ALTER TABLE `umiejetnosc_pracownik`
  ADD CONSTRAINT `umiejetnosc_pracownik_Poziom` FOREIGN KEY (`Poziom_id`) REFERENCES `poziom` (`id`),
  ADD CONSTRAINT `umiejetnosc_pracownik_Pracownik` FOREIGN KEY (`Pracownik_id`) REFERENCES `pracownik` (`id`),
  ADD CONSTRAINT `umiejetnosc_pracownik_Umiejetnosc` FOREIGN KEY (`Umiejetnosc_id`) REFERENCES `umiejetnosc` (`id`);

--
-- Ograniczenia dla tabeli `wizyta`
--
ALTER TABLE `wizyta`
  ADD CONSTRAINT `Wizyta_Zabieg` FOREIGN KEY (`Zabieg_id`) REFERENCES `zabieg` (`id`),
  ADD CONSTRAINT `Wizyty_Klient` FOREIGN KEY (`Klient_id`) REFERENCES `klient` (`id`),
  ADD CONSTRAINT `Wizyty_Pracownik` FOREIGN KEY (`Pracownik_id`) REFERENCES `pracownik` (`id`),
  ADD CONSTRAINT `Wizyty_Salon` FOREIGN KEY (`Salon_id`) REFERENCES `salon` (`id`);

--
-- Ograniczenia dla tabeli `zabieg`
--
ALTER TABLE `zabieg`
  ADD CONSTRAINT `Zabieg_Rodzaj` FOREIGN KEY (`Rodzaj_id`) REFERENCES `rodzaj` (`id`);
COMMIT;
