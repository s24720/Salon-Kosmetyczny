...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img style="filter: brightness(60%)" class="d-block w-100" src="https://www.positivelyaware.com/sites/default/files/article-images/Elizabeth-Taylor-1000x350px.jpg" height="350" alt="First slide">
        </div>
        <div class="carousel-item">
            <img style="filter: brightness(60%)" class="d-block w-100" src="https://www.positivelyaware.com/sites/default/files/Briefly-Columbus-Barcelona-statue-1000x350px.jpg" height="350" alt="Second slide">
        </div>
        <div class="carousel-item">
            <img style="filter: brightness(60%)" class="d-block w-100" src="https://www.biovendor.com/file/11183/uvod-mireia-tech-note-1000x350px.jpg?version=201809181102" height="350" alt="Third slide">
        </div>
    </div>
...
Oferujemy szeroki wachlarz zabiegów medycyny estetycznej, kosmetyki ciała oraz pielęgnacji twarzy, ciała i paznokci.</span>
            ...
            <div class="col-sm">
                <center>
                    <img src="https://afrodytasalon.pl/006-2" width="350" height="300" class="border border border-10 border-secondary rounded">
                </center>
            </div>
        </div>
    </div>
    ...
    <div  class="banner"> <img style="filter: brightness(60%)" src="https://secret-avenue.pl/wp-content/uploads/2019/08/re4.jpg" width="1000" height="600" class="border border border-10 border-secondary rounded">
        <div class="container">
...
Bony kwotowe to także idealny pomysł na prezent. Możesz odebrać je w formie eleganckiego vouchera w kopercie i wręczyć czy to na święta, dzień kobiet, na urodziny czy z dowolnej okazji.</span>
            </div>
            <div class="col-sm">
                <center>
                    <img src="https://bohoswing.com/wp-content/uploads/2019/03/201903-voucher-boho-swing.jpg" width="350" height="300" class="border border border-10 border-secondary rounded">
                </center>
            </div>
        </div>
    </div>
